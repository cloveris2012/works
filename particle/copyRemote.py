...
def copyAndroid():
    ...
    target_dir = "platform/android/particle/src/main/jniLibs/"
...
def modifyAndroidVersion(version_str):
    gradle_path = "platform/android/particle/build.gradle"
...
def modifyIOSVersion(version_str):
    podspec_path = "platform/ios/ParticleKit.podspec"
...
def copyIos():
    ios_dir = "./build/ios"
    target_dir = "platform/ios/ParticleKit"
