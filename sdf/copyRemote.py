...
def copyAndroid():
    ...
    target_dir = "platform/android/SDFFont/src/main/jniLibs/"
...
def modifyAndroidVersion(version_str):
    gradle_path = "platform/android/SDFFont/build.gradle"
...
def modifyIOSVersion(version_str):
    podspec_path = "platform/ios/SDFFontKit.podspec"
...
def copyIos():
    ios_dir = "./build/ios"
    target_dir = "platform/ios/SDFFontKit"
