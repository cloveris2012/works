#ifndef Skel_Skeleton_h
#define Skel_Skeleton_h
...
class SK_API Skeleton : public SkelObject {
...
public:
	explicit Skeleton(SkeletonData *skeletonData, SkeletonObjectCreator &creator);
	...
	std::vector<float> &getMatrices(bool refresh = false);
