#ifndef Skel_AnimationState_h
#define Skel_AnimationState_h
...
namespace skel {
	...
	class SK_API AnimationStateListenerObject {
	public:
	...
	class SK_API TrackEntry : public SkelObject, public HasRendererObject {
	...
	private:
		...
		bool _holdPrevious;
		int _initialLoopCount, _loopCount;
	...
	class SK_API EventQueueEntry : public SkelObject {
		friend class EventQueue;
	...
	class SK_API EventQueue : public SkelObject {
		friend class AnimationState;
	...
	class SK_API AnimationState : public SkelObject, public HasRendererObject {
	...
	public:
		...
		TrackEntry* setAnimation(size_t trackIndex, const String& animationName, int loopCount);
		...
		TrackEntry* setAnimation(size_t trackIndex, Animation* animation, int loopCount);

		/// Queues an animation by name.
		/// addAnimation(int, Animation, bool, float)
		TrackEntry* addAnimation(size_t trackIndex, const String& animationName, int loopCount, float delay);
		...
		/// after AnimationState.Dispose
		TrackEntry* addAnimation(size_t trackIndex, Animation* animation, int loopCount, float delay);
	...
	private:
		...
		TrackEntry* newTrackEntry(size_t trackIndex, Animation *animation, int loopCount, TrackEntry *last);
        ...
        void setAttachment(Skeleton &skeleton, skel::Slot &slot, const String &attachmentName, bool attachments);
    };
}

#endif /* Skel_AnimationState_h */
