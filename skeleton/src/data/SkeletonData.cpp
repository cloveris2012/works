...
SkeletonData::~SkeletonData() {
	...
	for (size_t i = 0; i < _strings.size(); i++) {
		SkelExtension::free(_strings[i], __FILE__, __LINE__);
	}
}
...
skel::EventData *SkeletonData::findEvent(const String &eventDataName) {
...
Vector<skel::EventData *> &SkeletonData::getEvents() {
	return _events;
}
