...
float Bone::localToWorldX(float localX, float localY) {
	return localX * _a + localY * _b + _worldX;
}

float Bone::localToWorldY(float localX, float localY) {
	return localX * _c + localY * _d + _worldY;
}
...
void Bone::setIndex(int inValue) {
	_index = inValue;
}
